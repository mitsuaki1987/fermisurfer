# -*- coding: utf-8 -*-
#
# Fermisurfer documentation build configuration file, created by
...
# of the sidebar.
html_logo = '../figs/fermisurfer.png'
...
latex_documents = [
  ('index', 'fermisurfer.tex', u'Fermisurfer Documentation',
   u'kawamura', 'manual'),
]
